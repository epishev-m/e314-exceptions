...
/// </summary>
[Serializable]
public class DetailedArgOutOfRangeException : DetailedException
{
	/// <summary>
	/// Initializes a new instance of the <see cref="DetailedArgOutOfRangeException"/> class with a specified parameter name, actual value, error message, error code, and additional error data.
	/// </summary>
	...
	public DetailedArgOutOfRangeException(
		string paramName,
		object actualValue,
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="DetailedArgOutOfRangeException"/> class with serialized data.
	/// </summary>
	/// <param name="info">The <see cref="SerializationInfo"/> that holds the serialized object data about the exception being thrown.</param>
	/// <param name="context">The <see cref="StreamingContext"/> that contains contextual information about the source or destination.</param>
	protected DetailedArgOutOfRangeException(SerializationInfo info, StreamingContext context)
		: base(info, context)
	{
	}
}
